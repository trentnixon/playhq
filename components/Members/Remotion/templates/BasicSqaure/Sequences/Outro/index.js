...
export const OutroSequenceFrame = ({ theme, fontFamily,durationInFrames }) => {
  const frame = useCurrentFrame();

	const StartClose=()=>{
		return durationInFrames-25
	}
	const CloseBy=()=>{
		return durationInFrames-5
	}
    ...
    <>
          ...
          <SponsorIntroContainer>
            <SponsorsIntroCopy
              style={{
                ...
                opacity: interpolateOpacityByFrame(frame, StartClose(), CloseBy(), 1, 0),
              }}
            >
        ...
        <LogoContainer
          style={{
            ...
            transform: `scale(${SpringToFrom(
              ...
              1,
              "Wobbly"
            )}) scale(${SpringToFrom(StartClose(), 1, 0, "Slow")})`,
          }}
        />
        <ClubNameContainer>
          <ClubName
        ...
        <SqareBG
          style={{
            ...
            clipPath: EraseFromMiddle(StartClose(), "Slow"),
          }}
        />
