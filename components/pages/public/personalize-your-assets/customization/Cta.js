          ...
          <div className="row align-items-center">
            <div className="col-lg-7 col-md-8">
              <div className="cta-content">
                ...
                <p>Enhance your club's digital presence with bespoke assets before the new season begins.</p>
                <p><strong>Special Offer:</strong> Was $599, now $399 till the end of July!</p>
              </div>
            </div>
