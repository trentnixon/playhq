    ...
    <div className={styles.whyChoose}>
      ...
      <div className={styles.content}>
        ...
        <P className='fade-in-up'>
          Fixtura revolutionizes your club&rsquo;s digital presence by
          automating the creation of various digital assets, including match
          reports, videos, and graphics. Our AI-driven platform aggregates data
          from PlayHQ and uses advanced tools to produce high-quality content
          tailored to your club&rsquo;s needs.
        </P>
      </div>
    </div>
  );
