// src/Components/Templates/Components/TemplateCardMembers.js
...
export function TemplateCardMembers({ template, isSelected, hasMediaItems }) {
  ...
  const handleCTAClick = () => {
    router.push(`/members/templateBuilder/${template.id}`);
  };
