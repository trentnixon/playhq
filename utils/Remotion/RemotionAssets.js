...
const createCategoryAssets = (template, data, keyMapping) => {
  ...
  return Object.keys(keyMapping).reduce((acc, key) => {
    const { componentKey, dataKey, title, titleSplit, compositionID, videoTitle } = keyMapping[key];
...
export const ASSETS = {
  Cricket: {
    ...
    CoastalCricketLeague: createCategoryAssets(Template_CoastalCricketLeague, cricketData, cricketKeyMapping),
  },
  AFL: {
