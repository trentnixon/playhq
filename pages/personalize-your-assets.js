  ...
  return (
    <>
      ...
      <Section {...WhycustomSectionData} color='dark'>
        ...
        <P color={0} textAlign='center' className='mt-4'>
          **Please note, this is a one-time design and development service and
          is not included in the season pass cost. The bespoke design service
          provided by Fixtura is used to give your club a unique look and feel
          for your assets. Your designs will not be available for other
          accounts, and will belong solely to your brand.**
        </P>
      </Section>
