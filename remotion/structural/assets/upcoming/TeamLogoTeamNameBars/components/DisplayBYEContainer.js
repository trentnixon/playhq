...
const BYEContainer = ({ matchData, FPS_SCORECARD, TemplateVariation, StyleConfig }) => {
  ...
  return (
    <TeamsAndScoresContainer>
      ...
      >
        <DisplayTeamName Value={CreateBye(teamHome, teamAway)} {...{FPS_SCORECARD, TemplateVariation, StyleConfig}} />
      </TeamScoreContainer>
    </TeamsAndScoresContainer>
  );
};
