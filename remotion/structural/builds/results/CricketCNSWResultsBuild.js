...
import {DisplayMetaItem} from '../../sport/cricket/TeamsAndScores/CNSWTeamsAndScores/MetaItem';
import {InningContainer} from '../../sport/cricket/TeamsAndScores/CNSWTeamsAndScores/InningContainer';

export const CricketCNSWResultsBuild = ({matchData}) => {
	...
	return (
		<MatchContainerStyles>
			...
			<TeamsAndScoresContainer>
				...
				<DisplayMetaItem VALUE={`${matchData.type} | ${round}`} />
			</TeamsAndScoresContainer>
		</MatchContainerStyles>
	);
};
