...
import {CricketCNSWREALFixtureResultsBuild} from '../../../../../structural/builds/SingleFixtureResult/CricketCNSWREALFixtureResultsBuild';
...
export const WeekendSingleGameResult = () => {
	...
	return (
		<Series>
			...
			>
				<CricketCNSWREALFixtureResultsBuild
